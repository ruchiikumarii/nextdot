        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-12 mb-16 md:mb-20">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="Nextdot Logo" className="h-8 w-auto object-contain" />
            </div>
          ...
          <div>
            <h4 className="font-semibold mb-4 md:mb-6">Platform</h4>
          ...
          <div>
            <h4 className="font-semibold mb-4 md:mb-6">Company</h4>
            <ul className="space-y-3 md:space-y-4 text-sm text-ink/60">
          ...
          <div>
            <h4 className="font-semibold mb-4 md:mb-6">Legal</h4>
            <ul className="space-y-3 md:space-y-4 text-sm text-ink/60">
